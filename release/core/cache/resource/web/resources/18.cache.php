<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1636980443,
    'editedby' => 1,
    'editedon' => 1637907156,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1636980420,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<title>Трест® || Цоколь, Каб. 12</title>
...
<script src="/js/jquery.hyphen.ru.min.js"></script>
<script type="text/javascript" src="/js/master.js"></script>',
    '[[if? &subject=`7` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    ...
    '[[if? &subject=`8` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    '[[if? &subject=`` &operator=`isempty` &then=`empty`]]' => 'empty',
    '[[removeSlashes? &url=``]]' => false,
    '[[if? &subject=`` &operator=`isempty` &then=``]]' => '',
    '[[if? &subject=`9` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    '[[if? &subject=`10` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    '[[if? &subject=`11` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    '[[if? &subject=`12` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    '[[if? &subject=`13` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    '[[if? &subject=`14` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    '[[if? &subject=`15` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    ...
    '[[if? &subject=`16` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    '[[if? &subject=`17` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    '[[if? &subject=`18` &operator=`EQ` &operand=`18` &then=`active`]]' => 'active',
    '[[if? &subject=`19` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    '[[if? &subject=`20` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
    '[[if? &subject=`21` &operator=`EQ` &operand=`18` &then=`active`]]' => '',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
