<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1636980231,
    'editedby' => 1,
    'editedon' => 1638449770,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1636980180,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'gallery',
      1 => '[{"MIGX_id":"7","title":"","image":"dns\\/2.jpg"},{"MIGX_id":"6","title":"","image":"dns\\/1.jpg"},{"MIGX_id":"8","title":"","image":"dns\\/3.jpg"},{"MIGX_id":"9","title":"","image":"dns\\/4.jpg"},{"MIGX_id":"10","title":"","image":"dns\\/5.jpg"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    array (
      0 => 'website',
      1 => 'http[s]://[www].domain.[subdomain].zone',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'logo',
      1 => 'magnit/magnete-cosmetics.svg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'timing',
      1 => '[["понедельник","8:00 – 18:00"],["вторник","8:00 – 18:00"],["среда","8:00 – 18:00"],["четверг","8:00 – 18:00"],["пятница","8:00 – 18:00"],["суббота","Выходной"],["воскресенье","Выходной"],["обед","13:00 – 14:00"]]',
      2 => 'default',
      3 => NULL,
      4 => 'table',
    ),
...
<title>Трест® || Цоколь, Каб. 1</title>
            ...
            <div class="container">
                <div class="row flex">
                    ...
                    <div class="col m5 s12 floor-description" id="floor-description">
                        ...
                        <h2>Кабинет №1</h2>
<div class="lazy rented-logo" data-src="/img/renters/magnit/magnete-cosmetics.svg"></div>
<ul class="tabs">
...
<div id="common">
    <div class="row">
        <div class="col s12">
            <h3>Магнит Косметикс</h3>
        </div>
        <div class="col xl7 l12 m12">
            <div class="gallery-main-image lazy" data-src="/img/renters/dns/2.jpg">
    <div class="image-title"></div>
</div>
            <div class="gallery-bullets">
                <div class="gallery-bullet tooltipped" data-src="/img/renters/dns/2.jpg" data-tooltip="" data-position="top"></div><div class="gallery-bullet tooltipped" data-src="/img/renters/dns/1.jpg" data-tooltip="" data-position="top"></div><div class="gallery-bullet tooltipped" data-src="/img/renters/dns/3.jpg" data-tooltip="" data-position="top"></div><div class="gallery-bullet tooltipped" data-src="/img/renters/dns/4.jpg" data-tooltip="" data-position="top"></div><div class="gallery-bullet tooltipped" data-src="/img/renters/dns/5.jpg" data-tooltip="" data-position="top"></div>
            </div>
        </div>
        <div class="col xl5 l12 m12">
            <table class="tvtable"><tbody><tr><td>понедельник</td><td>8:00 – 18:00</td></tr><tr><td>вторник</td><td>8:00 – 18:00</td></tr><tr><td>среда</td><td>8:00 – 18:00</td></tr><tr><td>четверг</td><td>8:00 – 18:00</td></tr><tr><td>пятница</td><td>8:00 – 18:00</td></tr><tr><td>суббота</td><td>Выходной</td></tr><tr><td>воскресенье</td><td>Выходной</td></tr><tr><td>обед</td><td>13:00 – 14:00</td></tr></tbody></table>
        </div>
    </div>
</div>
<div id="details">
...
<script src="/js/jquery.hyphen.ru.min.js"></script>
<script type="text/javascript" src="/js/master.js"></script>',
    '[[if? &subject=`7` &operator=`EQ` &operand=`7` &then=`active`]]' => 'active',
    ...
    '[[if? &subject=`8` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`` &operator=`isempty` &then=`empty`]]' => 'empty',
    '[[removeSlashes? &url=``]]' => false,
    '[[if? &subject=`` &operator=`isempty` &then=``]]' => '',
    '[[if? &subject=`9` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`10` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`11` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`12` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`13` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`14` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`15` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    ...
    '[[if? &subject=`16` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`17` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`18` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`19` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`20` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
    '[[if? &subject=`21` &operator=`EQ` &operand=`7` &then=`active`]]' => '',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
