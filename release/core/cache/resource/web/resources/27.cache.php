<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1637071101,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1637071101,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<title>Трест® || 1 этаж, Каб. 1</title>
    ...
    <main id="floor1" class="floor">
        <section id="floor-hero">
            <div class="container">
                ...
                <svg width="2000" height="569" viewBox="0 0 2000 569" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <rect width="2000" height="569" fill="url(#pattern0)"/>
    <path class="room" id="room1" d="M130.628 15L75 235H268.776L312 15L130.628 15Z"/>
    <path class="room" id="room2" d="M580 15L554 235H268.776L312 15L580 15Z"/>
    <path class="room" id="room3" d="M580.692 15L555 235H871.959L876 15L580.692 15Z"/>
    <path class="room" id="room4" d="M1278.94 15L1299 228H1154.79L1142 15L1278.94 15Z"/>
    <path class="room" id="room5" d="M1278 15L1297.95 228H1446L1419.98 15L1278 15Z"/>
    <path class="room" id="room6" d="M1554.5 15L1589 228H1446.09L1420 15L1554.5 15Z"/>
    <path class="room" id="room7" d="M1555 15L1589.28 228H1748L1703.64 15L1555 15Z"/>
    <path class="room" id="room8" d="M558 305H234.812L198 487H538L558 305Z"/>
    <path class="room" id="room9" d="M558 305H717L705 487H538L558 305Z"/>
    <path class="room" id="room10" d="M873 305H717.221L704 487H865.527L873 305Z"/>
    <path class="room" id="room11" d="M1307.5 301.5H1156.5L1166 487H1323L1307.5 301.5Z"/>
    <path class="room" id="room12" d="M1307.5 301.5H1456L1479 487H1323L1307.5 301.5Z"/>
    <path class="room" id="room13" d="M1608 301.5H1456L1479 487H1636.5L1608 301.5Z"/>
    <path class="room" id="room14" d="M1608 301.5H1758L1798.5 487H1636.5L1608 301.5Z"/>
    <path class="room" id="room15" d="M60.6831 305H236L199.198 487H12L60.6831 305Z"/>
    <defs>
    <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image0_159:684" transform="scale(0.0005 0.00175747)"/>
    </pattern>
    <pattern id="pattern1" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-0.316456 -0.0682804) scale(0.00421941 0.00454563)"/>
    </pattern>
    <pattern id="pattern2" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-0.863612 -0.0682804) scale(0.00321312 0.00454563)"/>
    </pattern>
    <pattern id="pattern3" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-1.72586 -0.0682804) scale(0.00311059 0.00454563)"/>
    </pattern>
    <pattern id="pattern4" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-7.26511 -0.0682804) scale(0.00636504 0.00469107)"/>
    </pattern>
    <pattern id="pattern5" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-7.60717 -0.0703743) scale(0.00595239 0.00469475)"/>
    </pattern>
    <pattern id="pattern6" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-8.40237 -0.0682804) scale(0.00591716 0.00469107)"/>
    </pattern>
    <pattern id="pattern7" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-8.05702 -0.0704305) scale(0.00518136 0.00469485)"/>
    </pattern>
    <pattern id="pattern8" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-0.550008 -1.67557) scale(0.00277778 0.00549407)"/>
    </pattern>
    <pattern id="pattern9" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-3.0056 -1.67557) scale(0.0055866, 0.00549433)"/>
    </pattern>
    <pattern id="pattern10" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-4.16578 -1.67572) scale(0.00591721 0.00549433)"/>
    </pattern>
    <pattern id="pattern11" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-6.94603 -1.62524) scale(0.00600604 0.00539067)"/>
    </pattern>
    <pattern id="pattern12" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-7.62401 -1.62524) scale(0.00583095 0.00539067)"/>
    </pattern>
    <pattern id="pattern13" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-8.06658 -1.62524) scale(0.00554021 0.00539067)"/>
    </pattern>
    <pattern id="pattern14" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-8.44104 -1.62524) scale(0.00524939 0.00539067)"/>
    </pattern>
    <pattern id="pattern15" patternContentUnits="objectBoundingBox" width="1" height="1">
    <use xlink:href="#image1_159:684" transform="translate(-0.0535121 -1.67581) scale(0.00446426 0.00549449)"/>
    </pattern>
    <image id="image0_159:684" width="2000" height="569" xlink:href="/img/floors/1F.png"/>
    <image id="image1_159:684" width="2000" height="569" xlink:href="/img/floors/1F_d.png"/>
    </defs>
</svg>
            </div>
        </section>
...
<script type="text/javascript" src="/js/master.js"></script>
  ...
  'elementCache' => 
  array (
    '[[parentData? &field=`pagetitle`]]' => '1 этаж',
...
[[!Wayfinder? &startId=`0` &level=`1` &outerTpl=`nav-bottom-wrapper` &showHiddden=`true` &excludeDocs=`1`]]',
    '[[parentData? &field=`alias`]]' => 'floor1',
    '[[parentData? 
                    &field=`parent`]]' => 2,
    '[[$floor1]]' => '<svg width="2000" height="569" viewBox="0 0 2000 569" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <rect width="2000" height="569" fill="url(#pattern0)"/>
    <path class="room" id="room1" d="M130.628 15L75 235H268.776L312 15L130.628 15Z"/>
    <path class="room" id="room2" d="M580 15L554 235H268.776L312 15L580 15Z"/>
    <path class="room" id="room3" d="M580.692 15L555 235H871.959L876 15L580.692 15Z"/>
    ...
    '[[$rented_tpl]]' => '<h2></h2>
<div class="lazy rented-logo" data-src=""></div>
<ul class="tabs">
...
<script src="/js/jquery.hyphen.ru.min.js"></script>
<script type="text/javascript" src="/js/master.js"></script>',
    '[[if? &subject=`27` &operator=`EQ` &operand=`27` &then=`active`]]' => 'active',
...
[[!Wayfinder? &startId=`0` &level=`1` &outerTpl=`nav-bottom-wrapper` &showHiddden=`true` &excludeDocs=`1`]]',
      ...
      array (
        ...
        array (
          ...
          'category' => 4,
          'cache_type' => 0,
          'snippet' => '<svg width="2000" height="569" viewBox="0 0 2000 569" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <rect width="2000" height="569" fill="url(#pattern0)"/>
    <path class="room" id="room1" d="M130.628 15L75 235H268.776L312 15L130.628 15Z"/>
    <path class="room" id="room2" d="M580 15L554 235H268.776L312 15L580 15Z"/>
    <path class="room" id="room3" d="M580.692 15L555 235H871.959L876 15L580.692 15Z"/>
    ...
    <image id="image1_159:684" width="2000" height="569" xlink:href="/img/floors/1F_d.png"/>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<svg width="2000" height="569" viewBox="0 0 2000 569" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <rect width="2000" height="569" fill="url(#pattern0)"/>
    <path class="room" id="room1" d="M130.628 15L75 235H268.776L312 15L130.628 15Z"/>
    <path class="room" id="room2" d="M580 15L554 235H268.776L312 15L580 15Z"/>
    <path class="room" id="room3" d="M580.692 15L555 235H871.959L876 15L580.692 15Z"/>
